      ...
      <div className="wrapper">
        ...
        <div className="calculator-container">
          ...
          <div className="route-graph-info-container">
            <RouteGraph route_data={this.state.data[Object.keys(this.state.data)[0]]} /> {/* you should pass data to child component with your own customized parameters */}
            <RouteGraph route_data={this.state.data[Object.keys(this.state.data)[1]]} /> {/* you should pass data to child component with your own customized parameters */}
            <StationInfo now={this.state.current_station_id}/> {/* you should pass data to child component with your own customized parameters */}
          </div>
